...
namespace eval ::optrace {
  variable script "D:/Desktop/magistrale/1_anno/1 SEMESTRE/architettura/esercizi/ESERCIZI TESINA/Cronometro/Cronometro.runs/synth_1/OrologioOnBoard.tcl"
...
synth_design -top OrologioOnBoard -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef OrologioOnBoard.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file OrologioOnBoard_utilization_synth.rpt -pb OrologioOnBoard_utilization_synth.pb"
